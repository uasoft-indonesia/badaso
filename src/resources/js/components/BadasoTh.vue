...
export default {
  ...
  computed: {
    ...
    isColumnSelectedForSort() {
      ...
      if(this.$parent.$parent.currentSortKey != this.sortKey) {
        this.resetSort();
      }
      return this.$parent.$parent.currentSortKey == this.sortKey;
    },
    parentSortStatus() {
  ...
  methods:{
    sortValue () {
      ...
      this.$parent.$parent.handleSort(this.sortKey, this.sortStatuses[this.currentSort]);
    },
    resetSort() {
      this.currentSort = 0;
    }
