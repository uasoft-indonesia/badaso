    ...
    <div class="badaso-upload-image-multiple__popup-dialog" tabindex="0" v-if="show">
      <div class="badaso-upload-image-multiple__popup-container">
        ...
        <div v-if="getSelected === 'url'" class="badaso-upload-image-multiple__popup--right-bar badaso-upload-image-multiple__popup--url-bar">
          <vs-input v-if="getSelected === 'url'" label="Paste an image URL here" placeholder="URL" v-model="inputByUrl" description-text="If your URL is correct, you'll see an image preview here. Large images may take a few minutes to appear. Only accept PNG and JPEG." @input="inputByUrl === '' ? dirty = false : dirty = true" />
