export default {
  ...
  "licenceIssue": {
    ...
    "licenceEmptyDescription": "You haven't entered BADASO_LICENCE_KEY in .env. Please fill in before you can use Badaso. For more complete instructions, please see here.",
