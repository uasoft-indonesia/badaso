export default {
  ...
  "licenceIssue": {
    ...
    "licenceEmptyDescription": "Anda belum memasukkan BADASO_LICENCE_KEY pada .env. Harap isi dahulu sebelum bisa menggunakan badaso. Untuk petunjuk lebih lengkap, bisa di lihat disini.",
